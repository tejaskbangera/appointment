...
public class Patientsdetailsbean {
	...
	public String toString() {
		return "Patientsdetailsbean [id=" + id + ", firstname=" + firstname + ", lastname=" + lastname + ", date="
				+ date + ", age=" + age + ", disease=" + disease + ", treatmentbefore=" + treatmentbefore + ", period="
				+ period + ", sufferringfrom=" + sufferringfrom + ", treatmentfor=" + treatmentfor + ", doctorid="
				+ doctorid + "]";
	}

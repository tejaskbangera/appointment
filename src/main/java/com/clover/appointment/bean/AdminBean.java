...
public class AdminBean {
	...
	public String toString() {
		return "AdminBean [userid=" + userid + ", firstname=" + firstname + ", lastname=" + lastname + ", age=" + age
				+ ", qualification=" + qualification + ", address=" + address + ", state=" + state + ", city=" + city
				+ ", landmark=" + landmark + ", pincode=" + pincode + ", aboutmyself=" + aboutmyself
